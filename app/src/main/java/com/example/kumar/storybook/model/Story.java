...
import com.example.kumar.storybook.R;

import java.util.ArrayList;

/**
 * Created by kumar on 2/21/2015.
 */
public class Story {
    ...
    public Story(){
        ...
        mPages.add(new Page());
        mPages.get(0).setImageId(R.drawable.page0);
        mPages.get(0).setText("On your return trip from studying Saturn's rings, you hear a distress signal that seems to be coming from the surface of Mars. It's strange because there hasn't been a colony there in years. Even stranger, it's calling you by name: \"Help me, %1$s, you're my only hope.\"");
        mPages.get(0).setChoice1(new Choice("Stop and investigate", 1));
        mPages.get(0).setChoice2(new Choice("Continue home to Earth", 2));
        mPages.add(new Page(
                R.drawable.page1,
